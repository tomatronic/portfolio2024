  ...
  return (
    <section className="py-24">
      <div className="container mx-auto max-w-6xl px-4">
        <h2 className="mb-10 text-2xl font-semibold tracking-tight text-slate-950 md:text-3xl">
          About Me
        </h2>

        <div className="overflow-hidden rounded-2xl border-2 border-slate-200/80 bg-white dark:border-slate-700/50 dark:bg-slate-900/50">
