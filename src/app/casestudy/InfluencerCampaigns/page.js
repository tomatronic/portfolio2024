        ...
        <>
            <div className="mt-4">
                <div className="container mx-auto h-[70vh] max-w-screen-xl rounded-2xl bg-[url('/backgroundBrew.png')] bg-cover">
                    <div className="mx-auto flex h-full max-w-screen-md flex-row flex-wrap place-content-center content-center">
                        <div className="flex flex-col">
                            <Zoom>
                                <Image src="/brewtifulBg.png" width={1600} height={927} alt="Influencer Campaigns product overview — advertiser and influencer interface for managing affiliate influencer campaigns on Rakuten Advertising" />
                            </Zoom>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto max-w-screen-md px-6 pt-12 pb-8">
                    ...
                    <p className="mb-6 text-sm uppercase tracking-wide text-gray-600 dark:text-gray-400">Rakuten Advertising &bull; Sept 2025 - Ongoing</p>
                    ...
                    <div className="border-t border-gray-200 pt-12 pb-4">
                        <p className="text-lg leading-8 text-gray-900 max-w-3xl mb-6">Rakuten Advertising needed to enter the influencer affiliate marketing space, fast. High-value advertisers were requesting an influencer solution that could integrate within their existing affiliate program. Aware that competitors offered this or similar experiences Rakuten Advertising risked losing high value, strategic accounts.</p>
                        <p className="text-lg leading-8 text-gray-900 max-w-3xl mb-6">The business case was clear:</p>
                        <ul className="mb-8 space-y-2 text-lg leading-8 text-gray-900 max-w-3xl">
                        ...
                        <p className="text-lg leading-8 text-gray-900 max-w-3xl">The challenge? Rakuten had never worked closely with influencers before. There was no infrastructure in place to connect social accounts, no management tools for campaigns and no creator facing UI. An added pressure was to meet a hard deadline for a demonstration of our vision to a prospective advertiser the following Monday.</p>
                    </div>
                </div>
                <div className="container mx-auto max-w-screen-md px-6">
                    <div className="grid auto-rows-auto grid-cols-1 gap-8 md:gap-12 md:grid-cols-4">
                        <div className="col-span-4 mb-12">
                            <h2 className="pt-10 text-xl tracking-tight mb-12">Challenge</h2>
                            <p className="mb-4 text-base leading-7 text-gray-900">This project had many constraints that can make design hard:</p>
                            <ul className="mb-8 space-y-2 text-base leading-7 text-gray-900">
                            ...
                            <p className="mb-4 text-base leading-7 text-gray-900">Week 1: Complete Prototype in 5 Days</p>
                            <p className="mb-4 text-base leading-7 text-gray-900">On Tuesday morning, I joined a briefing call with the VP of Product (based in the US). The requirements were shared and the big question was asked, "Can we demonstrate a compelling vision of this product to a prospect by Monday." That gave me less than a week.</p>
                            <p className="mb-4 text-base leading-7 text-gray-900">I started with a very light level of research to enable some quick user flows, which were beefed out with wireframes, and quickly iterated into a golden path click through prototype with high fidelity mocks.</p>
                            <p className="mb-4 text-base leading-7 text-gray-900">What I built in 5 days:</p>
                            <ul className="mb-8 space-y-2 text-base leading-7 text-gray-900">
                            ...
                            <p className="mb-4 text-base leading-7 text-gray-900">Why this approach worked:</p>
                            <ul className="mb-8 space-y-2 text-base leading-7 text-gray-900">
                            ...
                            <div className="mb-8">
                                <Zoom>
                                    <Image src="/sampleBeer.png" className="w-full rounded-2xl" width={500} height={542} alt="High-fidelity prototype screens delivered in five days showing the end-to-end influencer campaign flow for the prospect demo" />
                                </Zoom>
                            </div>
                            <h2 className="pt-10 text-xl tracking-tight mb-12">Key Decisions</h2>
                            <p className="mb-4 text-base leading-7 text-gray-900">With the prototype validated, I moved into detailed design and scoping. Here are the critical decisions made that helped to shape the product:</p>
                            <h3 className="pt-10">Ruthless V1 Scoping: Ship a Complete Story, Not Everything</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">With only three months to production, I worked with the PM to make hard choices about what to include in MVP versus what we could defer to a later iteration.</p>
                            <h3 className="pt-10">What I cut for V1:</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">In-app negotiation: Advertisers and influencers can't negotiate terms in-platform (V2 feature pending user feedback)
                            ...
                            <h3 className="pt-10">What I kept for V1:</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">Core campaign creation and editing
                            Influencer application flow
                            Social post verification (the key differentiator)
                            Basic campaign management and review tools</p>
                            <p className="mb-4 text-base leading-7 text-gray-900"><b className="font-semibold text-gray-950">The principle</b>: Ship a complete story a user can accomplish end-to-end, even if it's missing the extra polish we hope to include.</p>
                            <p className="mb-4 text-base leading-7 text-gray-900">The ruthless scoping had an unexpected benefit, it forced me to identify the absolute core value proposition. What's the ONE thing this product must do? Let advertisers create campaigns and let influencers apply and complete them. Everything else is enhancement.</p>
                            <h3 className="pt-10">Dual-Audience UI</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">Advertisers and influencers needed fundamentally different experiences from the same underlying campaign system.</p>
                            <h3 className="pt-10">For Advertisers (Campaign Creation):</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">Business-focused language: goals, deliverables, compensation structures
                            ...
                            <h3 className="pt-10">For Influencers (Campaign Discovery):</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">Opportunity-focused language: What's in it for them? What do they need to do?
                            ...
                            <p className="mb-4 text-base leading-7 text-gray-900">These couldn't be separate products (engineering would never deliver in time), but they couldn't feel identical either. Advertisers and influencers have fundamentally different needs.</p>
                            <p className="mb-4 text-base leading-7 text-gray-900">I decided on a solution that would share underlying components and data structures, but offer different content hierarchy and visual framing. Advertisers see "Campaign Management." Influencers see "Opportunities."</p>
                            <h3 className="pt-10">Social Post Verification</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">The most critical,and most uncertain, piece was social post detection. The external partner would somehow detect when an influencer posted about a campaign and link it to our system. But the exact mechanism wasn't finalized.</p>
                            <p className="mb-4 text-base leading-7 text-gray-900">How do you design a verification UI when you don't know exactly what data you'll receive or when you'll receive it?</p>
                            <h3 className="pt-10">My approach:</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">Design for the ideal state first: What should it look like if everything works perfectly? Show the post preview, engagement metrics, verification status.
                            ...
                            <p className="mb-4 text-base leading-7 text-gray-900">This "design for unknowns" approach gave engineering clear targets while building in adaptability for technical realities.</p>
                            <h3 className="pt-10">Influencer Profile Design</h3>
                            <p className="mb-4 text-base leading-7 text-gray-900">Advertisers needed to evaluate influencers before approving applications. But what data should we show?
                            ...
                            <p className="mb-12 text-base leading-7 text-gray-900">While another designer created the influencer landing page with campaign thumbnails, I owned the campaign detail page—where influencers decided whether to apply.
                            ...
                            <div className="mb-8">
                                <Zoom>
                                    <Image src="/initialDoodle.png" className="w-full rounded-2xl" width={1000} height={774} alt="Early wireframe sketches for the influencer campaign creation and discovery flows, exploring dual-audience UI patterns" />
                                </Zoom>
                            </div>
                            <h2 className="pt-10 text-xl tracking-tight mb-12">Testing and iteration</h2>
                            <div className="mb-12 space-y-6 text-base leading-7 text-gray-900">
                            ...
                            <div className="mb-8">
                                <Zoom>
                                    <Image src="/brewComp.png" className="w-full rounded-2xl" width={2390} height={1206} alt="Iteration notes and internal validation feedback from weeks two and three of the influencer campaigns project" />
                                </Zoom>
                            </div>
                            <h2 className="pt-10 text-xl tracking-tight mb-12">The solution</h2>
                            <p className="mb-8 text-base leading-7 text-gray-900">
                                    The final MVP design focused on the core workflow: Advertisers create campaigns, influencers discover and apply, content gets posted and verified (if required), incentives get distributed.
                                    Key design elements: progressive disclosure to show essential info first; card-based layouts flexible enough to handle variable data from external APIs; clear primary CTAs on every screen; dual-audience framing (same underlying system, different language and hierarchy for each user type); and visual hierarchy that makes incentives and requirements unmissable.
                                </p>
                                ...
                                <p className="mb-12 text-base leading-7 text-gray-900">Design the complete story, not individual features. Users don't experience "features", they experience workflows. By prototyping the end-to-end journey (advertiser creates campaign &gt; influencer applies &gt; content gets posted &gt; verification happens), I ensured we were building a usable product, not a collection of disconnected features.
                                </p>

                            <div className="mb-8 space-y-8">
                                <Zoom>
                                    <Image src="/beerLover.png" className="w-full rounded-2xl" width={1684} height={1190} alt="Advertiser persona — goals, pain points, and mental model for an advertiser using Rakuten's influencer campaign tools" />
                                </Zoom>
                                <Zoom>
                                    <Image src="/designLover.png" className="w-full rounded-2xl" width={1684} height={1190} alt="Influencer persona — goals, pain points, and mental model for a content creator using Rakuten's campaign discovery and application flow" />
                                </Zoom>
                            </div>
                            <br /><br /><br />
