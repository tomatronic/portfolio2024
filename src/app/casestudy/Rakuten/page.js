        ...
        <>
            <div className="mt-16">
                ...
                <div className="container mx-auto max-w-screen-md px-6 py-10">
                    <div className="text-3xl font-semibold tracking-tight text-gray-700">Offer management</div>
                    <p className="pt-4 text-sm font-medium uppercase text-gray-600">Rakuten Advertising &bull; June 2021 - August 2021</p>
                </div>
                ...
                <div className="container mx-auto max-w-screen-md px-6">
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-4 md:gap-10">
                        <div className="col-span-4 grid gap-16 pb-10">
                            <div>
                                <h2 className="text-xl font-semibold tracking-tight text-gray-700">Solution</h2>
                            ...
                            <div>
                                <h2 className="text-xl font-semibold tracking-tight text-gray-700">Discovery</h2>
                            ...
                            <div>
                                <h2 className="text-xl font-semibold tracking-tight text-gray-700">Gaining insight</h2>
                ...
                <div className="container mx-auto grid max-w-screen-md overflow-hidden rounded-2xl border bg-white shadow-[0px_1px_8px_rgba(13,34,71,0.12),_0px_28px_96px_rgba(13,34,71,0.1)]">
                    <div className="m-6 grid gap-2">
                        <h2 className="text-xl font-semibold tracking-tight text-gray-700">Goals</h2>
                ...
                <div className="container mx-auto max-w-screen-md px-6">
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-4 md:gap-10">
                        <div className="col-span-4 grid gap-16 pb-10">
                            <div>
                                <h2 className="pt-16 text-xl font-semibold tracking-tight text-gray-700">Planning</h2>
                            ...
                            <div>
                                <h2 className="pt-16 text-xl font-semibold tracking-tight text-gray-700">Sketching</h2>
                            ...
                            <div>
                                <h2 className="pt-16 text-xl font-semibold tracking-tight text-gray-700">Prototypes</h2>
                            ...
                            <div>
                                <h2 className="pt-16 text-xl font-semibold tracking-tight text-gray-700">Flow iteration</h2>
                            ...
                            <div>
                                <h2 className="pt-16 text-xl font-semibold tracking-tight text-gray-700">User testing</h2>
                            ...
                            <div>
                                <h2 className="pt-16 text-xl font-semibold tracking-tight text-gray-700">Outcome</h2>
